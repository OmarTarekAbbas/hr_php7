             ...
             <div class="sbox-content"> 	
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">	
                        ...
                        <button type="button" onclick="location.href ='{{ URL::to('mycommitments?return='.$return) }}' " class="btn btn-success btn-sm "><i class="fa  fa-arrow-circle-left "></i>  {{ Lang::get('core.sb_cancel') }} </button>
                        @if(!$row['id'])
