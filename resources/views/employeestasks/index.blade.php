                            ...
                            <tr class="{{check_task_status($row->id)}}">
                              ...
                              <td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ URL::to('employeestasks/show/'.$row->id.'?return='.$return)}}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
                                    @endif
                                    @if($access['is_edit'] ==1)
                                     @if($row->status==0)
                                    <a  href="{{ URL::to('employeestasks/update/'.$row->id.'?return='.$return) }}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_edit') }}"><i class="fa fa-edit "></i></a>
                                     @endif
                                    @endif
