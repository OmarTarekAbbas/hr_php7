    ...
    <div class="page-content-wrapper m-t">	 	
        ...
        <div class="sbox animated fadeInRight">
            ...
            <div class="sbox-content"> 	
                ...
                {!! Form::open(array('url'=>'permissions/delete/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) !!}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  width="100">
                                    ...
                                    <a href="{{ URL::to('permissions/show/'.$row->id.'?return='.$return)}}" class="tips btn btn-xs btn-white" title="{{ Lang::get('core.btn_view') }}"><i class="fa  fa-search "></i></a>
                                    @endif
...
<script>
    $(document).ready(function () {
        ...
        $('.do-quick-search').click(function () {
            $('#SximoTable').attr('action', '{{ URL::to("permissions/multisearch")}}');
            $('#SximoTable').submit();
        });
