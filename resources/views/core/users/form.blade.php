...
class='select2 '  required  ></select> --> 
                    ...
                    <div class="form-group  " >
                        <label for="vacation number" class=" control-label col-md-4 text-left"> Annual credit  </label>
                        <div class="col-md-6">
                            {!! Form::text('annual_credit', $row['annual_credit'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
                        </div> 
                        <div class="col-md-2">
                    ...
                    <div class="form-group  " >
                        <label for="vacation number" class=" control-label col-md-4 text-left"> Employee Finger Id  </label>
                        <div class="col-md-6">
                            {!! Form::text('employee_finger_id', $row['employee_finger_id'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                        </div>
                        <div class="col-md-2">
