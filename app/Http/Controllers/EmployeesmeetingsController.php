...
use App\Models\Employeesmeetings;
use App\User;
...
class EmployeesmeetingsController extends Controller {

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'employeesmeetings';
    static $per_page = '10';
    ...
    function getUpdate(Request $request, $id = null) {
        ...
        $this->data['id'] = $id;
        return view('employeesmeetings.form', $this->data);
    }
    ...
    public function getShow($id = null) {
        ...
        $this->data['id'] = $id;
        $this->data['access'] = $this->access;
        return view('employeesmeetings.view', $this->data);
    }
    ...
    function postSave(Request $request) {
        ...
        if ($validator->passes()) {
            $data = $this->validatePost('tb_employeesmeetings');
            ...
            if (!is_null($request->input('apply'))) {
                $return = 'employeesmeetings/update/' . $id . '?return=' . self::returnUrl();
            } else {
                $return = 'employeesmeetings?return=' . self::returnUrl();
            }
            ...
            return Redirect::to('employeesmeetings/update/' . $id)->with('messagetext', \Lang::get('core.note_error'))->with('msgstatus', 'error')
    ...
    public function postDelete(Request $request) {
        ...
        if (count($request->input('id')) >= 1) {
            ...
            // redirect
            return Redirect::to('employeesmeetings')
