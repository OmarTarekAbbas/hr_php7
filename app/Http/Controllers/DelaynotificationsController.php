...
class DelaynotificationsController extends Controller {

    protected $layout = "layouts.main";
    protected $data = array();
    public $module = 'delaynotifications';
    static $per_page = '10';
    ...
    function getUpdate(Request $request, $id = null) {
        ...
        if ($row) {
            ...
            $this->data['row'] = $this->model->getColumnTable('tb_delay_notifications');
        }
    ...
    public function getShow($id = null) {
        ...
        $this->data['id'] = $id;
        $this->data['access'] = $this->access;
        return view('delaynotifications.view', $this->data);
    }
    ...
    function postSave(Request $request) {
        ...
        if ($validator->passes()) {
            $data = $this->validatePost('tb_delaynotifications');
            ...
            if (!is_null($request->input('apply'))) {
                ...
                $return = 'delaynotifications?return=' . self::returnUrl();
            }
            ...
            return Redirect::to('delaynotifications/update/' . $id)->with('messagetext', \Lang::get('core.note_error'))->with('msgstatus', 'error')
    ...
    public function postDelete(Request $request) {
        ...
        if (count($request->input('id')) >= 1) {
            ...
            // redirect
            return Redirect::to('delaynotifications')
