...
class OvertimesController extends Controller {
    ...
    function getUpdate(Request $request, $id = null) {
        ...
        $this->data['id'] = $id;
        return view('overtimes.form', $this->data);
    }
    ...
    public function getShow($id = null) {
        ...
        $this->data['id'] = $id;
        $this->data['access'] = $this->access;
        return view('overtimes.view', $this->data);
    }
    ...
    function postSave(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            if (!is_null($request->input('apply'))) {
                ...
                $return = 'overtimes?return=' . self::returnUrl();
            }
            ...
            return Redirect::to('overtimes/update/' . $id)->with('messagetext', \Lang::get('core.note_error'))->with('msgstatus', 'error')
    ...
    public function getModify() {
        ...
        if ($overtimes) {
            foreach ($overtimes as $overtime) {
                $overtime->no_hours = str_replace(":", ".", $overtime->no_hours);
                $overtime->save();
            }
        }
    }
